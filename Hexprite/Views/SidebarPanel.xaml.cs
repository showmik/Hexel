...
namespace Hexprite.Views
{
    public partial class SidebarPanel : UserControl
    {
        ...
        {
            if (_vm == null || sender is not FrameworkElement fe) return;
            ...
            _vm.SetLayerVisibility(index, isVisible);
        }
        ...
        {
            if (_vm == null || !e.Data.GetDataPresent(typeof(LayerItemViewModel))) return;
